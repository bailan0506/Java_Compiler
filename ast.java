...
class DeclListNode extends ASTnode {
    ...
    public void nameAnalysis(SymTable symTab, SymTable globalTab) {
        for (DeclNode node : myDecls) {
            if (node instanceof VarDeclNode) {
                ...
                if(isGlobal){
                    ((VarDeclNode)node).setGlobal();
                    ((VarDeclNode)node).setOffset(-1);
                }
                else{
                    ((VarDeclNode)node).setOffset(AROffset);
                    AROffset-=4;
                }
            } else {
    ...
    public int getOffset(){
		return this.AROffset;
    }
		
    public int getSize(){
        return this.AROffset - this.declListOffset;
    }

    // list of kids (DeclNodes)
    private List<DeclNode> myDecls;
    private int AROffset=0;
...
class FormalsListNode extends ASTnode {
    ...
    public int getSize(){
        return this.AROffset - this.formalsListOffset;
    }
...
class StmtListNode extends ASTnode {
     ...
     */
    public void nameAnalysis(SymTable symTab) {
        AROffset=stmtListOffset;
        for (StmtNode node : myStmts) {
            node.nameAnalysis(symTab);
            node.setOffset(AROffset);
            AROffset=node.getOffset();
        }
    }    
	...
	public int getSize(){
		return this.AROffset-this.stmtListOffset;
	}
...
class VarDeclNode extends DeclNode {
    ...
    public void setOffset(int varDeclOffset){
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen(){
        ...
        Codegen.generate("subu",Codegen.SP,Codegen.SP,myBody.getSize());
        myBody.codeGen();
        Codegen.generateIndexed("lw", Codegen.RA, Codegen.FP, - myFormalsList.length()*4, "Load Return Address");
        Codegen.generateWithComment("move","Save control link", Codegen.T0, Codegen.FP);
        Codegen.generateIndexed("lw", Codegen.FP, Codegen.FP, -myFormalsList.length()*4-4, "Restore FP");
...
class WriteStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        else if(writeType.isIntType() || writeType.isBoolType()){
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beqz", Codegen.T0, Codegen.FALSE, ExitLabel);
        myDeclList.codeGen();
        myStmtList.codeGen();
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beqz", Codegen.T0, Codegen.FALSE,falseLabel);
...
class StringLitNode extends ExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generateLabeled(Label,".asciiz ","StringLit", myStrVal);
		Codegen.generate(".text");
...
class NotNode extends UnaryExpNode {
    ...
    public void codeGen(){
        ...
        Codegen.generate("xor",Codegen.T1,Codegen.T1,Codegen.T0);
        Codegen.genPush(Codegen.T1);
    }
}
...
class AndNode extends LogicalExpNode {
    ...
    public void codeGen(){
        String Label=Codegen.nextLabel();
        myExp1.codeGen();
        Codegen.generate("lw",Codegen.T0,Codegen.SP,4);
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen(){
        ...
        myExp1.codeGen();
        Codegen.generate("lw",Codegen.T0,Codegen.SP,"4");
        Codegen.generate("bne",Codegen.T0,Codegen.FALSE,Label);
        myExp2.codeGen();
        Codegen.genPop(Codegen.T1);
        Codegen.genPop(Codegen.T0);
